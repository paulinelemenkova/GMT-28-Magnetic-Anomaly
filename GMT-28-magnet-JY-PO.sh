...
grdcut EMAG2_V3_UpCont_DataTiff.tif -R110/295/-70/70 -Gpo_mag.tif

#
gdalinfo po_mag.tif -stats
#Minimum=-3380.9753417969, Maximum=8632.6142578125
# Step-5. Make color palette
gmt makecpt -Ccyclic -T-3381/8633 > mag.cpt
# makecpt --help

# Step-1. Generate a file
ps=Magnetism_PO.ps
gmt grdimage po_mag.tif -Cmag.cpt -R110/295/-70/70 -JY180/0/6.5i -P -I+a15+ne0.75 -Xc -K > $ps
