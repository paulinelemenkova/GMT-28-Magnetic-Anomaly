...
grdcut EMAG2_V3_UpCont_DataTiff.tif -R47/77/0/31  -Gas_mag.tif

#
gdalinfo as_mag.tif -stats
#Minimum=-547, Maximum=661
# Step-5. Make color palette
gmt makecpt -Cdem2 -T-547/661/1 > mag.cpt
# makecpt --help

# Step-1. Generate a file
ps=Magnetism_AS.ps
gmt grdimage as_mag.tif -Cmag.cpt -R47/77/0/31 -JT62/15/6i -P -I+a15+ne0.75 -Xc -K > $ps
