...
gmt grdcut @earth_wdmam_03m -R-40/150/-70/-10 -Gker_mag.nc
...
gmt psbasemap -R -J \
    ...
    -B+t"World Digital Magnetic Anomaly Map (WDMAM), 3 arc min resolution" \
...
gmt psconvert Magnet_Kgl_WDMAM.ps -A1.7c -E720 -Tj -Z
